...
int main(void) {
    ...
    stNode member5 = {10006, (int)5, "YI TaeYeob", "032-4251-0548", "DOMAIN", 0, 0};
    stNode member6 = {10007, (int)6, "JEONG SeungYeon", "02-257-2254", "SECURITY", 0, 1};
    stNode member7 = {10008, (int)7, "JEONG InJae", "010-0587-3525", "DOMAIN", 0 ,1};
    stNode member8 = {10009, (int)8, "CHOI EunBeom", "010-8759-7452", "VEHICLE", 0, 0};
